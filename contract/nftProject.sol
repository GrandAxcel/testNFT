...
// GO TO LINE 1904 TO SEE WHERE THE NFT CONTRACT STARTS
...
contract testNFT is ERC721, Ownable {
    ...
    string public test_PROVENANCE = ""; // IPFS URL WILL BE ADDED WHEN NFTS ARE ALL SOLD OUT
    
    string public LICENSE_TEXT = ""; // IT IS WHAT IT SAYS
    
    bool licenseLocked = false; // TEAM CAN'T EDIT THE LICENSE AFTER THIS GETS TRUE

    uint256 public constant NFTPrice = 10000000000000000; // 0.025 ETH
    ...
    // Reserve 5 nfts for team - Giveaways/Prizes etc
    uint public nftReserve = 5;
    
    event NFTNameChange(address _by, uint _tokenId, string _name);
    
    event licenseisLocked(string _licenseText);

    constructor() ERC721("Test NFT", " TP") { }
